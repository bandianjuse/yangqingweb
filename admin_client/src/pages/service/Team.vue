  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        ...
        <el-form-item>
          <el-button type="primary" v-on:click="getTeamList">查询</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <!--列表-->
    <el-table :data="team" highlight-current-row v-loading="listLoading" @selection-change="selsChange"
              style="width: 100%;">
    ...
    <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="职位" prop="job">
          <el-input v-model="editForm.job" auto-complete="off" placeholder="请输入职位"></el-input>
        </el-form-item>
    ...
    <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
      <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
        ...
        <el-form-item label="职位" prop="job">
          <el-input v-model="addForm.job" auto-complete="off" placeholder="请输入职位"></el-input>
        </el-form-item>
        <el-form-item label="图片" prop="imagePath">
          <el-upload
            class="avatar-uploader"
...
<script>
  ...
  import {getTeamList,  addTeam, editTeam, removeTeam, batchRemoveTeam } from '../../api/api';
  export default {
    data() {
      return {
        filters: {
