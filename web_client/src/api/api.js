...
export const getNewsDetails = params => { return axios.get(`${base}/news/details`, { params: params }); };
...
export const newsThumbUp = params => { return axios.get(`${base}/news/thumbUp`, { params: params }); };

export const newsBrowse = params => { return axios.get(`${base}/news/browse`, { params: params }); };
...
export const getWorksQuery = params => { return axios.get(`${base}/works/query`, { params: params }); };

export const getWorksDetails = params => { return axios.get(`${base}/works/details`, { params: params }); };
...
export const worksThumbUp = params => { return axios.get(`${base}/works/thumbUp`, { params: params }); };

export const worksBrowse = params => { return axios.get(`${base}/works/browse`, { params: params }); };
...
export const getJobDetails = params => { return axios.get(`${base}/job/details`, { params: params }); };
...
export const confingDetails = params => { return axios.get(`${base}/confing/details`, { params: params }); };
